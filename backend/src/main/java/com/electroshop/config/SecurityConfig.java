...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Stateless JWT API → CSRF tokens are not applicable; protection comes from
                // no cookie-based auth + SameSite. Disable the servlet CSRF filter.
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow all Vercel domains (production + preview) plus local dev.
        // Patterns are required (not plain origins) so wildcards work with credentials.
